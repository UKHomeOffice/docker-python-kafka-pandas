...
RUN apk add cmake build-base bash gcc g++ musl-dev git libffi-dev librdkafka-dev
...
#RUN apk add --upgrade libcrypto3 libssl3 busybox libarchive libexpat libxml2 perl sqlite-libs curl libcurl python3 python3-pyc python3-pycache-pyc0 binutils libxml2  xz xz-dev xz-libs
#
ENV CFLAGS="-Wno-deprecated-declarations -Wno-unreachable-code"

#
RUN pip install cython==0.29.37 pandas==2.3.0 confluent-kafka==v1.5.0
#
